...
void CodeGenVisitor::Visit(Node* n) { if(n) n->accept(this); }
void CodeGenVisitor::Visit(Stmt* s) { if(s) s->accept(this); }
void CodeGenVisitor::Visit(Exp* e) { if(e) e->accept(this); }
